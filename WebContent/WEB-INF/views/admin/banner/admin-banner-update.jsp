	...
	<div class="row">
		...
		<div class="col-xs-11">
			<div class="container">
				...
				<div class="well">
					<form method="post" action="allUpdate.kakao" enctype="multipart/form-data" onsubmit="checkValue(event)">
						
						<div class="form-group">
						<input type="hidden" value="${banner.no }" name="no">
						...
						<div class="form-group">
							<div class="row">
								...
								<div class="col-xs-11">
									<input type="text" class="form-control" name="bannerTitle" id="bannerTitle" value="${banner.title }" />
								</div>
							</div>
							<div class="row">
								<div class="col-xs-1">
								...
								<div class="col-xs-11">
									<input type="text" class="form-control" name="bannerSubTitle" id="bannerSubTitle" value="${banner.subTitle }" />
								</div>
							</div>
							<div class="row">
								<div class="col-xs-1">
								...
								<div class="col-xs-4">
									<%-- <input type="text" class="form-control" name="productNo" value="${banner.product.no }" /> --%>
						...
						<div class="form-group">
							<div class="row">
								...
								<div class="col-xs-1 admin-padding">
								    <input type="checkbox" name="bannerDispalyYn" value="Y" ${banner.displayYn eq "Y" ? "checked" : ""}/>
								</div>
								<div class="col-xs-1 admin-padding">
									<label >노출순서</label>
								</div>
								<div class="col-xs-1">
									<input type="text" class="form-control admin-margin-buttom" name="bannerPriority" id="bannerPriority" value="${banner.priority }" />
								</div>
							</div>
						</div>
						<div class="form-group">
							<div class="row">
								...
								<div class="col-xs-11">
								    <input type="file" name="bannerFile" value="${banner.imgName }"/>
