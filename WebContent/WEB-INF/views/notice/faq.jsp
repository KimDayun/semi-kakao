		...
		<div class="row" style="margin-bottom: 15px;">
			<div class="col-sm-12">
				<ul class="nav nav-tabs">
					<li class=""><a href="notice.kakao?pno=1">공지사항</a></li>
					<li class="active"><a href="faq.kakao?pno=1">FAQ</a></li>
				</ul>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-sm-12">
					<p class="box-padding">
						...
						<fmt:formatDate value="${faq.createDate }" pattern="yyyy.MM.dd" />
					</p>
					<p class="box-padding box" style="font-size: 30px;">${faq.title }
						<button class="btn btn-default" style="border: 0px;"
							onclick="showDetail(${faq.no })" id="btn-show-${faq.no }">
							<span class="glyphicon glyphicon-menu-down"></span>
						</button>
					</p>
				</div>
			</div>
			<div class="row" style="display: none;" id="detail-button-${faq.no }">
				<div class="col" style="background-color: #f6f6f6;">
					<p class="box-padding">${faq.contents }</p>
				</div>
			</div>
			<hr>
		</c:forEach>
		...
		<div class="text-center">
			<ul class="pagination">
				<c:choose>
					...
					<c:otherwise>
						<li><a href="faq.kakao?pno=${pno-1 }">&laquo;</a></li>
					</c:otherwise>
				...
				<c:choose>
					...
					<c:otherwise>
						<li><a href="faq.kakao?pno=${pno+1 }">&raquo;</a></li>
					</c:otherwise>
				</c:choose>
			</ul>
		</div>
